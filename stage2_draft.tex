...
\begin{itemize}
The user is given 3 different similarity measures for searching. We will begin with the first similarity measure: 1) users who select a topic and bring up a cluster of tweets related to that topic.
...
\item[$\diamond$]{\bf 2a) Recommending similar tweets and hashtags based on network similarity}\\
...
\item[$\diamond$]{\bf 2b)Time and Space Complexity of Algorithm 3}\\
